                        ...
                        transfer_direction dir, int size, Bool* mod)
{
   ...
   *mod = False;
   ...
   // We do not support fpu yet.
   // case 34: VG_(transfer) (&loongarch64->guest_F0,   buf, dir, size, mod); break;
   // case 35: VG_(transfer) (&loongarch64->guest_F1,   buf, dir, size, mod); break;
   // case 36: VG_(transfer) (&loongarch64->guest_F2,   buf, dir, size, mod); break;
   // case 37: VG_(transfer) (&loongarch64->guest_F3,   buf, dir, size, mod); break;
   // case 38: VG_(transfer) (&loongarch64->guest_F4,   buf, dir, size, mod); break;
   // case 39: VG_(transfer) (&loongarch64->guest_F5,   buf, dir, size, mod); break;
   // case 40: VG_(transfer) (&loongarch64->guest_F6,   buf, dir, size, mod); break;
   // case 41: VG_(transfer) (&loongarch64->guest_F7,   buf, dir, size, mod); break;
   // case 42: VG_(transfer) (&loongarch64->guest_F8,   buf, dir, size, mod); break;
   // case 43: VG_(transfer) (&loongarch64->guest_F9,   buf, dir, size, mod); break;
   // case 44: VG_(transfer) (&loongarch64->guest_F10,  buf, dir, size, mod); break;
   // case 45: VG_(transfer) (&loongarch64->guest_F11,  buf, dir, size, mod); break;
   // case 46: VG_(transfer) (&loongarch64->guest_F12,  buf, dir, size, mod); break;
   // case 47: VG_(transfer) (&loongarch64->guest_F13,  buf, dir, size, mod); break;
   // case 48: VG_(transfer) (&loongarch64->guest_F14,  buf, dir, size, mod); break;
   // case 49: VG_(transfer) (&loongarch64->guest_F15,  buf, dir, size, mod); break;
   // case 50: VG_(transfer) (&loongarch64->guest_F16,  buf, dir, size, mod); break;
   // case 51: VG_(transfer) (&loongarch64->guest_F17,  buf, dir, size, mod); break;
   // case 52: VG_(transfer) (&loongarch64->guest_F18,  buf, dir, size, mod); break;
   // case 53: VG_(transfer) (&loongarch64->guest_F19,  buf, dir, size, mod); break;
   // case 54: VG_(transfer) (&loongarch64->guest_F20,  buf, dir, size, mod); break;
   // case 55: VG_(transfer) (&loongarch64->guest_F21,  buf, dir, size, mod); break;
   // case 56: VG_(transfer) (&loongarch64->guest_F22,  buf, dir, size, mod); break;
   // case 57: VG_(transfer) (&loongarch64->guest_F23,  buf, dir, size, mod); break;
   // case 58: VG_(transfer) (&loongarch64->guest_F24,  buf, dir, size, mod); break;
   // case 59: VG_(transfer) (&loongarch64->guest_F25,  buf, dir, size, mod); break;
   // case 60: VG_(transfer) (&loongarch64->guest_F26,  buf, dir, size, mod); break;
   // case 61: VG_(transfer) (&loongarch64->guest_F27,  buf, dir, size, mod); break;
   // case 62: VG_(transfer) (&loongarch64->guest_F28,  buf, dir, size, mod); break;
   // case 63: VG_(transfer) (&loongarch64->guest_F29,  buf, dir, size, mod); break;
   // case 64: VG_(transfer) (&loongarch64->guest_F30,  buf, dir, size, mod); break;
   // case 65: VG_(transfer) (&loongarch64->guest_F31,  buf, dir, size, mod); break;
   // case 66: VG_(transfer) (&loongarch64->guest_FCC0, buf, dir, size, mod); break;
   // case 67: VG_(transfer) (&loongarch64->guest_FCC1, buf, dir, size, mod); break;
   // case 68: VG_(transfer) (&loongarch64->guest_FCC2, buf, dir, size, mod); break;
   // case 69: VG_(transfer) (&loongarch64->guest_FCC3, buf, dir, size, mod); break;
   // case 70: VG_(transfer) (&loongarch64->guest_FCC4, buf, dir, size, mod); break;
   // case 71: VG_(transfer) (&loongarch64->guest_FCC5, buf, dir, size, mod); break;
   // case 72: VG_(transfer) (&loongarch64->guest_FCC6, buf, dir, size, mod); break;
   // case 73: VG_(transfer) (&loongarch64->guest_FCC7, buf, dir, size, mod); break;
   // case 74: VG_(transfer) (&loongarch64->guest_FCSR, buf, dir, size, mod); break;
   default: vg_assert(0);
   }
}
