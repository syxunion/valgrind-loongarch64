...
#define TESTINST_RR(insn, rd, rj, v1, v2)         \
   {                                              \
      ...
      __asm__ __volatile__(                       \
         ...
         : rd, rj, "memory");                     \
      printf("%s %s, %s ::\n", insn, rd, rj);     \
      printf("before: %s=%#016lx, %s=%#016lx\n",  \
             rd, val1, rj, val2);                 \
      printf("after:  %s=%#016lx, %s=%#016lx\n",  \
             rd, res1, rj, res2);                 \
   }
...
#define TESTINST_RI(insn, rd, type, v1, imm)    \
   {                                            \
      ...
      showImm(imm, type);                       \
      printf(" ::\n");                          \
      printf("before: %s=%#016lx\n", rd, val1); \
      printf("after:  %s=%#016lx\n", rd, res1); \
   }
...
#define TESTINST_RRRI(insn, rd, rj, rk, type, v1, v2, v3, imm) \
   {                                                           \
      ...
      showImm(imm, type);                                      \
      printf(" ::\n");                                         \
      printf("before: %s=%#016lx, %s=%#016lx, %s=%#016lx\n",   \
             rd, val1, rj, val2, rk, val3);                    \
      printf("after:  %s=%#016lx, %s=%#016lx, %s=%#016lx\n",   \
