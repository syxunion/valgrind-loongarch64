...
static IRExpr* getFCSR ( UInt iregNo )
{
   ...
   switch (iregNo) {
      case 0:
         return fcsr0;
      case 1:
         /* FCSR1 is Enables of FCSR0. */
         return binop(Iop_And32, fcsr0, mkU32(0x0000001f));
      case 2:
...
static void putFCSR ( UInt iregNo, IRExpr* e )
{
   ...
   switch (iregNo) {
      ...
      case 1:
         /* FCSR1 is Enables of FCSR0. */
         and1 = binop(Iop_And32, fcsr0, mkU32(0xffffffe0));
         and2 = binop(Iop_And32, e, mkU32(0x0000001f));
         break;
      case 2:
         /* FCSR2 is Cause and Flags of FCSR0. */
                            ...
                            const VexAbiInfo* abiinfo )
{
   ...
   IRExpr** arg = mkIRExprVec_3(getIReg64(rd), getIReg64(rj), mkU64(8));
   IRExpr* call = mkIRExprCCall(Ity_I64, 1/*regparms*/,
                            ...
                            const VexAbiInfo* abiinfo )
{
   ...
   IRExpr** arg = mkIRExprVec_3(getIReg64(rd), getIReg64(rj), mkU64(16));
   IRExpr* call = mkIRExprCCall(Ity_I64, 1/*regparms*/,
                                "loongarch64_calculate_crc",
                                &loongarch64_calculate_crc,
                                arg);
                            ...
                            const VexAbiInfo* abiinfo )
{
   ...
   IRExpr** arg = mkIRExprVec_3(getIReg64(rd), getIReg64(rj), mkU64(32));
   IRExpr* call = mkIRExprCCall(Ity_I64, 1/*regparms*/,
                                "loongarch64_calculate_crc",
                                &loongarch64_calculate_crc,
                                arg);
                            ...
                            const VexAbiInfo* abiinfo )
{
   ...
   IRExpr** arg = mkIRExprVec_3(getIReg64(rd), getIReg64(rj), mkU64(64));
   IRExpr* call = mkIRExprCCall(Ity_I64, 1/*regparms*/,
                                "loongarch64_calculate_crc",
                                &loongarch64_calculate_crc,
                                arg);
                                   ...
                                   UInt fj, UInt fk, Bool size64 )
{
   ...
   if (size64)
      assign(cond, binop(Iop_CmpF64, getFReg64(fj), getFReg64(fk)));
   else
      assign(cond, binop(Iop_CmpF32, getFReg32(fj), getFReg32(fk)));
   ...
   switch (op) {
      ...
      case FCMP_CLE_S: case FCMP_CLE_D: case FCMP_SLE_S: case FCMP_SLE_D:
         e = binop(Iop_Or1, is_LT(mkexpr(cond)), is_EQ(mkexpr(cond)));
         break;
