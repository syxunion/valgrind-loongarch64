                                          ...
                                          VexGuestLOONGARCH64State* vex_state )
{
   ...
   /* FPU Registers */
   vex_state->guest_F0   = 0; /* Argument registers / Return value */
   vex_state->guest_F1   = 0;
   vex_state->guest_F2   = 0; /* Argument registers */
   vex_state->guest_F3   = 0;
   vex_state->guest_F4   = 0;
   vex_state->guest_F5   = 0;
   vex_state->guest_F6   = 0;
   vex_state->guest_F7   = 0;
   vex_state->guest_F8   = 0; /* Temporary registers */
   ...
   vex_state->guest_F24  = 0; /* Static registers */
